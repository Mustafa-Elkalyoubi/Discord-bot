...
import ReminderFromNowSubCommand from "./add/from-now.js";
import ReminderAtSubCommand from "./add/at.js";
import RecurringReminderSubCommand from "./add/recurring.js";

export default class ReminderMainCommand extends BaseSlashSubCommand implements BaseSubCommand {
  constructor() {
    super(
      "reminder",
      [
        {
          name: "add",
          subCommands: [
            ReminderFromNowSubCommand,
            ReminderAtSubCommand,
            RecurringReminderSubCommand,
          ],
        },
      ],
      [CheckSubCommand, RemoveSubCommand]
    );
  }
