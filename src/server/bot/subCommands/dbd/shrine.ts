...
class ShrineSubCommand extends BaseSubCommandRunner implements SubCommand {
  constructor(baseCommand: string, group?: string | null) {
    super(baseCommand, group ?? null, "shrine");
  }
...
export default ShrineSubCommand;
